...
function showCode(selector)
{
	...
	document.querySelectorAll(selector).forEach(
		function(e)
		{
			...
			preDiv.innerText = e.outerHTML.replace(/\t/g, "");
			/* preDiv.innerText = codeFormate(e.outerHTML); */
...
function CreateDownloadLink(fileLink, fileName)
{
	let l = document.createElement('A');
	l.href = fileLink || location.href;
	l.download = fileName || '';
	return l;
...
function wrap (toWrap, wrapper) {
	...
	toWrap.insertAdjacentElement("afterend", wrapper);
